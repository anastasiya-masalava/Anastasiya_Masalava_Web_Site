export const projects = [
  {
    title: "Mood Tunes",
    subtitle: "ML-Driven Web Application",
    description:
      "MoodTunes is tool that is capable of recognising a person's mood by photo and suggesting Top 5 Spotify songs based on the mood.",
    image: "./mood_tunes.gif",
    link: "https://github.com/adriencao/moodtunes",
  },
  {
    title: "Assembly Pipeline",
    subtitle: "Circuit Pipeline for Assembly Code",
    description:
      "A fully functioning pipeline that handles different assembly instructions preventing unnecessary stalling and handling branching.",
    image: "./assembly_video.gif",
    link: "https://github.com/anastasiya-masalava/Pipeline",
  },
  {
    title: "Crossy Road",
